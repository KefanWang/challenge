...
def parse_args():
    ...
    parser.add_argument('--test_output_csv', type=str, default='challenge/data/result.csv')
    parser.add_argument('--val_ratio', default=0.1, type=float, help='split 10 percentages of training data as validation')
    parser.add_argument('--batch_size', default=300, type=int, help="use for training duration per worker")
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='/content/gdrive/MyDrive/save/v1')
    parser.add_argument('--ckpt_file', type=str, default='challenge/save/v1/model_.bin')
    ...
    parser.add_argument('--warmup_steps', default=400, type=int, help="warm ups for parameters not in bert or vit")
    ...
    parser.add_argument("--gradient_acc_step", default=5, type=int)
    
    # ========================== Title BERT =============================
    parser.add_argument('--bert_dir', type=str, default='hfl/chinese-macbert-base')
    parser.add_argument('--bert_cache', type=str, default='challenge/data/cache')
